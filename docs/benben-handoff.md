> 2026-09-24 更新：默认语言生成已切云端豆包，六套模型与 30 段动画已整合。当前启动和验证以 [集中检查](release-check-2026-09-24.md) 与 benben 的最新 integration-handoff 为准；下文 Qwen/Ollama 是历史回滚说明。网页由项目所有者发布，无需新增 Pages Token。
