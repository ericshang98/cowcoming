...
export const ACTION_CATALOG = {
  ...
  NOD_DOUBLE: {
    label: "得意双点头",
    en: "Proud double nod",
    animation: "nod-double",
    suffix: "nod_proud",
  },
  TILT_LEFT: {
    label: "左侧好奇歪头",
    en: "Curious tilt left",
    animation: "tilt-left",
    suffix: "tilt_curious_left",
  },
  TILT_RIGHT: {
    label: "右侧好奇歪头",
    en: "Curious tilt right",
    animation: "tilt-right",
    suffix: "tilt_curious_right",
  },
};
export const ACTION_IDS = [...Object.keys(ACTION_CATALOG), "WAIT"];
export const DEFAULT_MAP = Object.fromEntries([
  ...Object.entries(ACTION_CATALOG).map(([id, a]) => [id, [a.animation]]),
  ["WAIT", ["idle"]],
]);
...
export function availableDeviceActions(state) {
  if (
    state.profile.actionContractVersion !== ACTION_CONTRACT_VERSION ||
    state.device.actionContractVersion !== ACTION_CONTRACT_VERSION
  )
    return [];
